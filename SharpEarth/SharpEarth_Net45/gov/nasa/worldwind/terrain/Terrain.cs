...
public interface Terrain
{
     ...
     * <p/>
     * This operation fails with a {@link SharpEarth.exception.WWTimeoutException} if a timeout has been
     ...
     * @throws SharpEarth.exception.WWTimeoutException
     ...
     *
     * @throws ArgumentException if the specified location in null.
     * @throws SharpEarth.exception.WWTimeoutException
     *                                  if the current timeout is exceeded while retrieving terrain data.
     * @throws SharpEarth.exception.WWRuntimeException
     *                                  if the operation is interrupted.

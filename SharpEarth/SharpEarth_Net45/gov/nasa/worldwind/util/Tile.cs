...
public class Tile implements Comparable<Tile>, Cacheable
{
    ...
    private double priority = Double.MaxValue; // Default is minimum priority
...
//        }
     ...
     *
     * @throws ArgumentException if <code>delta</code> is null or non-positive, or <code>latitude</code> is null,
     ...
     *
     * @throws ArgumentException if <code>delta</code> is null or non-positive, or <code>longitude</code> is
     ...
     *
     * @throws ArgumentException if the grid interval (<code>delta</code>) is null or zero or the row index is
     *                                  negative.
     */
     ...
     *
     * @throws ArgumentException if the grid interval (<code>delta</code>) is null or zero or the column index is
     *                                  negative.
     */

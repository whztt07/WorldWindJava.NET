...
public class RestorableSupport
{
     ...
     *
     * @throws ArgumentException if the specified element name is null or empty.
     */
     ...
     *
     * @throws ArgumentException If <code>stateInXml</code> is null, or the its contents are not a well formed
     *                                  XML document.
     */
     ...
     * SharpEarth.util.RestorableSupport}. The <code>name</code> and simple String <code>value</code> of a
    ...
    public static class StateObject
    {
         ...
         *
         * @throws ArgumentException If <code>value</code> is null.
         */
     ...
     *
     * @throws ArgumentException If <code>stateObjectTagName</code> is null.
     */
     ...
     *
     * @throws ArgumentException If <code>stateObject</code> is null, or does not belong to this
     *                                  RestorableSupport.
     */
     ...
     *
     * @throws ArgumentException If <code>color</code> is null.
     */
     ...
     *
     * @throws ArgumentException If <code>encodedString</code> is null.
     */
    ...
    public static void adjustTitleAndDisplayName(AVList parameters)
    {
        String displayName = parameters.getStringValue(AVKey.DISPLAY_NAME);
        if (displayName == null && parameters.getValue(AVKey.TITLE) != null)
            parameters.setValue(AVKey.DISPLAY_NAME, parameters.getValue(AVKey.TITLE));
    }
}
}

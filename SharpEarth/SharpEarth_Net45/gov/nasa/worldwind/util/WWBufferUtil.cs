...
public class WWBufferUtil
{
     ...
     * Recognized primitive types are as follows: <ul> <li>{@link SharpEarth.avlist.AVKey#INT8} <li>{@link
     * SharpEarth.avlist.AVKey#INT16} <li>{@link SharpEarth.avlist.AVKey#INT32} <li>{@link
     * SharpEarth.avlist.AVKey#FLOAT32} <li>{@link SharpEarth.avlist.AVKey#FLOAT64} </ul>
     *

 ...
 * pathType - {@link SharpEarth.render.Polyline#LINEAR}, {@link SharpEarth.render.Polyline#RHUMB_LINE}
 * or {@link SharpEarth.render.Polyline#GREAT_CIRCLE}.</p>
 *
...
public class AreaMeasurer extends LengthMeasurer implements MeasurableArea
{
     ...
     * @throws ArgumentException if steps is less then one.
     */
     ...
     * @throws ArgumentException if globe is <code>null</code>.
     */

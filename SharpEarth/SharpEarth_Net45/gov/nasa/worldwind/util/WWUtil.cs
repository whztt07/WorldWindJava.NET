...
public class WWUtil
{
     ...
     *                                  null, if <code>hemisphere</code> is not one of {@link SharpEarth.avlist.AVKey#NORTH}
     *                                  or {@link SharpEarth.avlist.AVKey#SOUTH}, if <code>buffer</code> is
     ...
     *
     * @throws ArgumentException if <code>buffer</code> is null, or if the number of remaining elements in
     ...
     *
     * @throws ArgumentException  if the parent object or the property name is null.
     ...
     *                 vertex buffer.
     *
     * @throws ArgumentException if any of the specified buffers are null or the limit of the normal

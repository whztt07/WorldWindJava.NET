...
using SharpEarth.data.ByteBufferRaster;
...
public class ElevationsUtil
{
    ...
    * @throws ArgumentException if <code>raster</code> is <code>null</code>
    */
   public static void rectify(ByteBufferRaster raster) throws ArgumentException
   {
       if( null == raster )
       {

...
public class ImageUtil
{
     ...
     *
     * @throws ArgumentException if either <code>image</code> or <code>canvas</code> is null.
     */
     ...
     *
     * @throws ArgumentException if any of <code>image</code>, <code>canvas</code>, or <code>canvasToImageTransform</code>
     *                                  are null.
     */
     ...
     *
     * @throws ArgumentException if any of <code>sourceImage</code>, <code>destImage</code>,
     ...
     * @return bounding sector for the geographically aligned destination image.
     *
     * @throws ArgumentException if any of <code>sourceImage</code>, <code>destImage</code> or
     ...
     *
     * @throws ArgumentException if any of <code>imagePoints</code>, <code>geoPoints</code>,
     ...
     *
     * @throws ArgumentException if either <code>imageWidth</code> or <code>imageHeight</code> are less than 1,
     ...
     *
     * @throws ArgumentException if the any of the reference arguments are null or the aspect ratio is less than
     *                                  or equal to zero.
     */
     ...
     *         maxLevel + 1.
     *
     * @throws ArgumentException if <code>image</code> is null, or if <code>maxLevel</code> is less than zero.
     ...
     *
     * @throws ArgumentException if either <code>width</code> or <code>height</code> are less than 1.
     */
    ...
    public static Sector calcBoundingBoxForUTM(AVList parameters) throws IOException
    {
        if (null == parameters)
        {
            String message = Logging.getMessage("nullValue.ParamsIsNull");
        ...
        double xPixelSize = (Double) parameters.getValue(WorldFile.WORLD_FILE_X_PIXEL_SIZE);
        double yPixelSize = (Double) parameters.getValue(WorldFile.WORLD_FILE_Y_PIXEL_SIZE);

        double xLocation = (Double) parameters.getValue(WorldFile.WORLD_FILE_X_LOCATION);
        double yLocation = (Double) parameters.getValue(WorldFile.WORLD_FILE_Y_LOCATION);

        Integer zone = (Integer) parameters.getValue(AVKey.PROJECTION_ZONE);
        String hemisphere = (String) parameters.getValue(AVKey.PROJECTION_HEMISPHERE);
        ...
        parameters.setValue(AVKey.ORIGIN, new LatLon(upperLeft.getLatitude(), upperLeft.getLongitude()));

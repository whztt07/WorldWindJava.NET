 ...
 * All Rights Reserved.
 */
using SharpEarth.cache.BasicSessionCache;
...
public class AbsentResourceList
{
     ...
     *
     * @throws ArgumentException if max-tries is less than 1 or the minimum check interval is less than 0.
     */
     ...
     *
     * @throws ArgumentException if max-tries is less than 1 or if either the minimum check interval or try-again
     ...
     * @param maxTries the number of max tries. Must be greater than 0.
     *
     * @throws ArgumentException if max-tries is less than 1.
     */
     ...
     * @param minCheckInterval the check interval. Must be greater than or equal to 0.
     *
     * @throws ArgumentException if the minimum check interval is less than 0.
     */
     ...
     * @param tryAgainInterval the try-again interval.  Must be greater than or equal to 0.
     *
     * @throws ArgumentException if the try-again interval is less than 0.
     */

 ...
 */
     ...
     *
     * @throws ArgumentException if the file path is null.
     ...
     *
     * @throws ArgumentException if either the document or file path is null.
     ...
     *
     * @throws ArgumentException if either the document or input stream is null.
     * @throws WWRuntimeException       if an exception or error occurs while writing the document. The causing
     *                                  exception is included in this exception's {@link Throwable#initCause(Throwable)}
     */
 ...
 */
     ...
     *
     * @throws ArgumentException if the event reader is null.
     */
     ...
     *         is found.
     *
     * @throws ArgumentException if either the context, XPath expression or XPath sub-expression are null.
     */
    ...
    /**
     * Returns the {@link SharpEarth.geom.LatLon} value of an element identified by an XPath expression.
     *
     * @param context the context from which to start the XPath search.
     ...
     *
     * @return the value of an element matching the XPath expression, or null if no match is found or the match does not
     *         contain a {@link SharpEarth.geom.LatLon}.
     *
     * @throws ArgumentException if the context is null.
     */
    ...
    /**
     * Returns the {@link SharpEarth.geom.Sector} value of an element identified by an XPath expression.
     *
     * @param context the context from which to start the XPath search.
     ...
     *
     * @return the value of an element matching the XPath expression, or null if no match is found or the match does not
     *         contain a {@link SharpEarth.geom.Sector}.
     *
     * @throws ArgumentException if the context is null.
     */
    ...
    /**
     * Returns the {@link SharpEarth.util.LevelSet.SectorResolution} value of an element identified by an XPath
     * expression.
     *
     * @param context the context from which to start the XPath search.
     ...
     *
     * @return the value of an element matching the XPath expression, or null if no match is found or the match does not
     *         contain a {@link SharpEarth.util.LevelSet.SectorResolution}.
     *
     * @throws ArgumentException if the context is null.
     */
     ...
     *
     * @throws ArgumentException if the context or pattern is null.
     */
    ...
    /**
     * Returns the {@link SharpEarth.render.ScreenCredit} value of an element identified by an XPath
     * expression.
     *
     * @param context the context from which to start the XPath search.
     ...
     *
     * @throws ArgumentException if the document is null, if the name is null, or if the name is empty.
     */
     ...
     *                  when performing multiple searches. May be null.
     *
     * @throws ArgumentException if either the context, parameter list, parameter key or parameter name are
     *                                  null.
     */
    public static void checkAndSetStringParam(Element context, AVList parameters, String paramKey, String paramName,
        XPath xpath)
    {
        if (context == null)
        {
        ...
        if (s == null)
        {
            ...
            if (s != null && s.length() > 0)
                parameters.setValue(paramKey, s.trim());
        }
    }
     ...
     *                                  null.
     */
    public static void checkAndSetStringArrayParam(Element context, AVList parameters, String paramKey, String paramName,
        XPath xpath)
    {
        if (context == null)
        {
        ...
        if (o == null)
        {
            ...
            if (strings != null && strings.length > 0)
                parameters.setValue(paramKey, strings);
        }
    }
     ...
     *                                  null.
     */
    public static void checkAndSetUniqueStringsParam(Element context, AVList parameters, String paramKey, String paramName,
        XPath xpath)
    {
        if (context == null)
        {
     ...
     *                                  null.
     */
    public static void checkAndSetDoubleParam(Element context, AVList parameters, String paramKey, String paramName,
        XPath xpath)
    {
        if (context == null)
        {
        ...
        if (o == null)
        {
            ...
            if (d != null)
                parameters.setValue(paramKey, d);
        }
    }
     ...
     *                                  null.
     */
    public static void checkAndSetIntegerParam(Element context, AVList parameters, String paramKey, String paramName,
        XPath xpath)
    {
        if (context == null)
        {
     ...
     *                                  null.
     */
    public static void checkAndSetLongParam(Element context, AVList parameters, String paramKey, String paramName,
        XPath xpath)
    {
        if (context == null)
        {
     ...
     *                                  null.
     */
    public static void checkAndSetBooleanParam(Element context, AVList parameters, String paramKey, String paramName,
        XPath xpath)
    {
        if (context == null)
        {
     ...
     *                                  null.
     */
    public static void checkAndSetLatLonParam(Element context, AVList parameters, String paramKey, String paramName,
        XPath xpath)
    {
        if (context == null)
        {
        ...
        if (o == null)
        {
            ...
            if (ll != null)
                parameters.setValue(paramKey, ll);
        }
    }
     ...
     *                                  null.
     */
    public static void checkAndSetColorParam(Element context, AVList parameters, String paramKey, String paramName,
        XPath xpath)
    {
        if (context == null)
        {
        ...
        if (o == null)
        {
            ...
            if (color != null)
                parameters.setValue(paramKey, color);
        }
    }

    public static void checkAndSetColorArrayParam(Element context, AVList parameters, String paramKey, String paramName,
        XPath xpath)
    {
        if (context == null)
        {
        ...
        if (o == null)
        {
            ...
            parameters.setValue(paramKey, colors);
        }
    }
     ...
     *                                  null.
     */
    public static void checkAndSetSectorParam(Element context, AVList parameters, String paramKey, String paramName,
        XPath xpath)
    {
        if (context == null)
        {
        ...
        if (o == null)
        {
            ...
            if (sector != null)
                parameters.setValue(paramKey, sector);
        }
    }
     ...
     *                                  null.
     */
    public static void checkAndSetSectorResolutionParam(Element context, AVList parameters, String paramKey,
        String paramName, XPath xpath)
    {
        ...
        if (o == null)
        {
            ...
            parameters.setValue(paramKey, srs);
        }
    }
     ...
     *                                  null.
     */
    public static void checkAndSetTimeParam(Element context, AVList parameters, String paramKey, String paramName,
        XPath xpath)
    {
        if (context == null)
        {
     ...
     *                                  null.
     */
    public static void checkAndSetTimeParamAsInteger(Element context, AVList parameters, String paramKey, String paramName,
        XPath xpath)
    {
        if (context == null)
        {
        ...
        if (o == null)
        {
            ...
            if (d != null)
                parameters.setValue(paramKey, d.intValue());
        }
    }
     ...
     *                  when performing multiple searches. May be null.
     *
     * @throws ArgumentException if either the context, parameter list, parameter key, pattern or parameter name
     *                                  are null.
     */
    public static void checkAndSetDateTimeParam(Element context, AVList parameters, String paramKey, String paramName,
     ...
     *                                  null.
     */
    public static void checkAndSetScreenCreditParam(Element context, AVList parameters, String paramKey, String paramName,
        XPath xpath)
    {
        if (context == null)
        {
        ...
        if (o == null)
        {
            ...
            if (sc != null)
                parameters.setValue(paramKey, sc);
        }
    }
     ...
     * @throws ArgumentException if either the parameter list  parameter key, or context are null.
     */
    public static void checkAndAppendTextArrayElement(AVList parameters, String paramKey, Element context, String path)
    {
        if (params == null)
        {
            String message = Logging.getMessage("nullValue.ParametersIsNull");
     ...
     * @throws ArgumentException if either the parameter list  parameter key, or context are null.
     */
    public static void checkAndAppendIntegerlement(AVList parameters, String paramKey, Element context, String path)
    {
        if (params == null)
        {
            String message = Logging.getMessage("nullValue.ParametersIsNull");
     ...
     * @throws ArgumentException if either the parameter list  parameter key, or context are null.
     */
    public static void checkAndAppendLongElement(AVList parameters, String paramKey, Element context, String path)
    {
        if (params == null)
        {
            String message = Logging.getMessage("nullValue.ParametersIsNull");
     ...
     * @throws ArgumentException if either the parameter list  parameter key, or context are null.
     */
    public static void checkAndAppendBooleanElement(AVList parameters, String paramKey, Element context, String path)
    {
        if (params == null)
        {
            String message = Logging.getMessage("nullValue.ParametersIsNull");
     ...
     * @throws ArgumentException if either the parameter list  parameter key, or context are null.
     */
    public static void checkAndAppendLatLonElement(AVList parameters, String paramKey, Element context, String path)
    {
        if (params == null)
        {
            String message = Logging.getMessage("nullValue.ParametersIsNull");
     ...
     * @throws ArgumentException if either the parameter list  parameter key, or context are null.
     */
    public static void checkAndAppendSectorElement(AVList parameters, String paramKey, Element context, String path)
    {
        if (params == null)
        {
            String message = Logging.getMessage("nullValue.ParametersIsNull");
     ...
     * @throws ArgumentException if either the parameter list  parameter key, or context are null.
     */
    public static void checkAndAppendSectorResolutionElement(AVList parameters, String paramKey, Element context,
        String path)
    {
        if (params == null)
        {
     ...
     * @throws ArgumentException if either the parameter list  parameter key, or context are null.
     */
    public static void checkAndAppendTimeElement(AVList parameters, String paramKey, Element context,
        String path)
    {
        if (params == null)
        {
     ...
     * @throws ArgumentException if either the parameter list  parameter key, or context are null.
     */
    public static void checkAndAppendScreenCreditElement(AVList parameters, String paramKey, Element context, String path)
    {
        if (params == null)
        {
            String message = Logging.getMessage("nullValue.ParametersIsNull");
     ...
     *
     * @throws ArgumentException if the byte order is null.
     */
     ...
     *
     * @throws ArgumentException if the data type is null.
     */
     ...
     * @param parameters  an attribute-value list to copy the properties to.
     *
     ...
     *
     * @throws ArgumentException if the specified element is null.
     */
    public static AVList copyProperties(Element element, AVList parameters)
    {
        if (element == null)
        {
            String message = Logging.getMessage("nullValue.ElementIsNull");
        ...
        try
        {
            ...
            foreach (Element el in elements)
            {
                ...
                parameters.setValue(prop, value);
            }
        }
     ...
     *
     * @throws ArgumentException if the specified object or XML document element is null.

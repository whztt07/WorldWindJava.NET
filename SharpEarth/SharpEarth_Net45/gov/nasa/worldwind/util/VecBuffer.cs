...
public class VecBuffer
{
     ...
     *
     * @throws ArgumentException if the position is out of range, or if the array is null.
     */
     ...
     *
     * @throws ArgumentException if the position is out of range, if the array is null, or if the array has
     *                                  insufficient length.
     */
     ...
     *
     * @throws ArgumentException if the position is out of range, or if this buffer cannot store a Vec4.
     */
     ...
     *
     * @throws ArgumentException if the position is out of range, if the vector is null, or if this buffer cannot
     *                                  store a Vec4.
     */
     ...
     *
     * @throws ArgumentException if the position is out of range, or if this buffer cannot store a LatLon.
     */
     ...
     *
     * @throws ArgumentException if the position is out of range, if the LatLon is null, or if this buffer cannot
     *                                  store a LatLon.
     */
     ...
     *
     * @throws ArgumentException if the position is out of range, or if this buffer cannot store a Position.
     */
     ...
     *
     * @throws ArgumentException if the position is out of range, if the Position is null, or if this buffer
     ...
     *
     * @throws ArgumentException if the position is out of range, or if the iterable is null.
     */
     ...
     * @param iterable iterator over the elements to set.
     *
     * @throws ArgumentException if the position is out of range, if the iterable is null, or if this buffer
     *                                  cannot store a Vec4.
     */
     ...
     *
     * @throws ArgumentException if the DrawContext is null, or if this buffer is not compatible as a color
     *                                  buffer.
     */
     ...
     * @param dc the current {@link DrawContext}.
     *
     * @throws ArgumentException if the DrawContext is null, or if this buffer is not compatible as a normal
     *                                  buffer.
     */
     ...
     *
     * @throws ArgumentException if the DrawContext is null, or if this buffer is not compatible as a vertex
     *                                  buffer.
     */

...
public class WWIO
{
     ...
     *
     * @throws ArgumentException if the specified string is null.
     */
     ...
     *
     * @throws ArgumentException if the source is null or an empty string.
     */
     ...
     *         encoding.
     *
     * @throws ArgumentException if the <code>url</code> is null.
     * @throws IOException              if an I/O error occurs.
    ...
    public static ByteBuffer readGZipFileToBuffer(File gzFile) throws ArgumentException, IOException
    {
        if (gzFile == null)
        {
            String message = Logging.getMessage("nullValue.FileIsNull");
    ...
    private static ByteBuffer transferStreamToByteBuffer(InputStream stream, int numBytes) throws IOException
    {
        ...
        if (numBytes < 1)
        {
            ...
            throw new ArgumentException(Logging.getMessage("WWIO.NumberBytesTransferLessThanOne"));
        }
     ...
     *
     * @throws ArgumentException if the <code>stream</code> is null.
     * @throws IOException              if an I/O error occurs.
     */
     ...
     *
     * @throws ArgumentException if the channel or the buffer is null.
     * @throws IOException              if an I/O error occurs.
     */
     ...
     *
     * @throws ArgumentException if the <code>reader</code> is null.
     * @throws IOException              if an I/O error occurs.
     */
     ...
     *
     * @throws ArgumentException if the mime type is null or malformed.
     */
     ...
     *
     * @throws ArgumentException if the file suffix is null.
     */
     ...
     * <tr><td>application/bil32</td><td>{@link SharpEarth.avlist.AVKey#FLOAT32}</td></tr>
     * <tr><td>application/bil16</td><td>{@link SharpEarth.avlist.AVKey#INT16}</td></tr>
     * <tr><td>application/bil</td><td>{@link SharpEarth.avlist.AVKey#INT16}</td></tr>
     * <tr><td>image/bil</td><td>{@link SharpEarth.avlist.AVKey#INT16}</td></tr> </table>
     *
     ...
     *
     * @throws ArgumentException if <code>string</code> is null.
     */
     ...
     *
     * @throws ArgumentException if <code>buffer</code> is null.
     */
     ...
     *
     * @throws ArgumentException if the text string or file is null.
     */
     ...
     *
     * @throws ArgumentException if the file name is null.
     ...
     * @return the string representation of the bytes in the buffer decoded according to the specified encoding.
     *
     * @throws ArgumentException if the buffer is null or the length is less than 1.
     * @throws java.nio.charset.IllegalCharsetNameException
     *                                  if the specified encoding name is illegal.
     * @throws java.nio.charset.UnsupportedCharsetException
     *                                  if no support for the named encoding is available.
     ...
     *
     * @throws ArgumentException if the source is null, an empty string, or is not one of the above types.

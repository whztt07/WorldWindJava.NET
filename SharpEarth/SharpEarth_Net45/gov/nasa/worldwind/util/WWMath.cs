...
public class WWMath
{
    ...
    /**
     * Returns the distance in model coordinates from the {@link SharpEarth.View} eye point to the specified
     * {@link SharpEarth.geom.Extent}. If the View eye point is inside the extent, this returns 0.
     *
     * @param dc     the {@link SharpEarth.render.DrawContext} which the View eye point is obtained from.
     ...
     *
     * @throws ArgumentException if either the DrawContext or the extent is null.
     */
    ...
    /**
     * Returns the size in window coordinates of the specified {@link SharpEarth.geom.Extent} from the current
     * {@link SharpEarth.View}. The returned size is an estimate of the Extent's diameter in window
     * coordinates.
     *
     ...
     *
     * @throws ArgumentException if the <code>view</code> is <code>null</code>, if <code>center</code> is
     ...
     *
     * @throws ArgumentException if any of the specified vertices are null.
     */
     ...
     *
     * @throws ArgumentException if points is null.
     */
...
//                result = !result;
     ...
     *         polytope.
     *
     * @throws ArgumentException if the line is null or ill-formed, the planes array is null or there are fewer
     *                                  than three planes.
     */
     ...
     *
     * @throws ArgumentException if either the width or height are less than or equal to zero.
     */
     ...
     *
     * @throws ArgumentException if either the index buffer or the vertex buffer is null.
     */
     ...
     *
     * @throws ArgumentException if any of the lists are null, the number of control positions is less than 2, or
     *                                  the globe is null.
     */
     ...
     *
     * @throws ArgumentException if the necessary point, previous or next references are null, either the left or

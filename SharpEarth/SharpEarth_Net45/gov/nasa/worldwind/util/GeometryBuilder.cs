...
public class GeometryBuilder
{
        ...
        boolean[] terrainConformant, int slices, int stacks, Vec4 refPoint, float[] dest)
    {
        ...
        for (int i = 0; i < slices; i++)
        {
            ...
            double azimuth = (Math.PI / 2.0) - (Math.Acos(xLength / distance) * Math.Sign(yLength) - heading.radians);
...
//        }
        ...
        double altitude, bool terrainConformant, int slices, int loops, Vec4 refPoint, float[] dest)
    {
        ...
        for (int s = 0; s < slices; s++)
        {
            ...
            for (int l = 0; l <= loops; l++)
            {
                ...
                double azimuth = (Math.PI / 2) - (Math.Acos(xLength / r) * Math.Sign(yLength) - heading.radians);
     ...
     *
     * @throws ArgumentException if any of <code>majorRadius</code>, <code>minorRadius</code>, or
     ...
     * @return a buffer containing the ellipse's x and y locations.
     *
     * @throws ArgumentException if any of <code>majorRadius</code>, <code>minorRadius</code>,
     ...
     *
     * @throws ArgumentException if either <code>width</code> or <code>height</code> are less than zero.
     */
     ...
     * @return a buffer containing the rectangle's x and y locations.
     *
     * @throws ArgumentException if any of <code>width</code>, <code>height</code>, <code>cornerRadius</code>, or
     ...
     * @return a buffer containing the rectangle's x and y locations.
     *
     * @throws ArgumentException if any of <code>width</code>, <code>height</code>, <code>cornerRadius</code>,

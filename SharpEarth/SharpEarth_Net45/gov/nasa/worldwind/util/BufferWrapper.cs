...
public abstract class BufferWrapper
{
     ...
     *
     * @throws ArgumentException if either the byteBuffer or the data type are null.
     */
     ...
     * @return a new BufferWrapper backed by the specified byteBuffer.
     *
     * @throws ArgumentException if either the byteBuffer or the parameters are null, or if AVKey.DATA_TYPE
    ...
    public static BufferWrapper wrap(ByteBuffer byteBuffer, AVList parameters)
    {
        ...
        return wrap(byteBuffer, parameters.getValue(AVKey.DATA_TYPE), parameters.getValue(AVKey.BYTE_ORDER));
    }

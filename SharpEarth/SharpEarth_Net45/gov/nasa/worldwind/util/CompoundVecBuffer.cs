 ...
 * SharpEarth.util.VecBuffer} objects. Each VecBuffer is retrieved via an index. The range of valid indices in a
...
public abstract class CompoundVecBuffer
{
     ...
     *
     * @throws ArgumentException if beginIndex is out of range, if endIndex is out of range, or if beginIndex >
     *                                  endIndex.
     */
     ...
     * @return a new CompoundVecBuffer representing a subset of this CompoundVecBuffer.
     *
     * @throws ArgumentException if the array of indices is null, if the offset or length are invalid, or if any
     ...
     * @return a new CompoundVecBuffer representing a subset of this CompoundVecBuffer.
     *
     * @throws ArgumentException if the array of indices is null, or if any of the indices is out of range.
     */

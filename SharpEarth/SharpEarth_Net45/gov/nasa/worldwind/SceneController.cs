...
public interface SceneController : WWObject, Disposable
{
    ...
    /**
     * Specifies the scene controller's model. This method fires an {@link SharpEarth.avlist.AVKey#MODEL}
    ...
    /**
     * Returns the current view. This method fires an {@link SharpEarth.avlist.AVKey#VIEW} property change
     * event.
     *
     ...
     * SharpEarth.events.SelectEvent}s.
     *
    ...
    /**
     * Specifies the performance values to monitor. See {@link SharpEarth.util.PerformanceStatistic} for the
     * available keys.
     *
    ...
    /**
     * Specifies the {@link SharpEarth.render.ScreenCreditController} to use for displaying screen credits for

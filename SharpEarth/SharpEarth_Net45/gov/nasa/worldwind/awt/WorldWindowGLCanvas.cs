...
using java.beans;
using java.awt;
using javax.media.opengl.awt.GLCanvas;
 ...
 * capable {@link SceneController} such as {@link SharpEarth.StereoSceneController} must also be specified in
 ...
 * associated with the current {@link SharpEarth.render.DrawContext} so that they are automatically cleared, and

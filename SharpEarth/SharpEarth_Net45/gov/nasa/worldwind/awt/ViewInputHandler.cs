...
public interface ViewInputHandler : KeyListener, MouseListener, MouseMotionListener, MouseWheelListener, FocusListener
{
     ...
     * This method does not start the {@link SharpEarth.animation.Animator}.  Starting the
     * {@link SharpEarth.animation.Animator} is the responsibility of the application.
     * This method is here primarily for use by the {@link SharpEarth.View}.  Applications should call
     * {@link SharpEarth.View#addAnimator(gov.nasa.worldwind.animation.Animator)} to add an animtion to the
     * view.
     *
    ...
    /**
     * Implementations are expected to apply any changes to the {@link SharpEarth.View} state prior to the View

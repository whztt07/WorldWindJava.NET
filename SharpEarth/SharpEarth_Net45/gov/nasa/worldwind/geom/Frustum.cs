...
public class Frustum
{
     ...
     *
     * @throws ArgumentException if the projection matrix is null.
     */
     ...
     *
     * @throws ArgumentException if fov is not in the range (0, 180), if either near or far are negative, or near
     ...
     *
     * @throws ArgumentException if the difference of any plane set (lright - left, top - bottom, far - near) is
     ...
     *
     * @throws ArgumentException if any of the vectors are null, if either near or far are negative, or near is

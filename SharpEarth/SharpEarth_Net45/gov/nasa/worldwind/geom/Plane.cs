...
public sealed class Plane
{
     ...
     *
     * @throws ArgumentException if the normal vector components define the zero vector (all values are zero).
     */
     ...
     *
     * @throws ArgumentException if <code>pa</code>, <code>pb</code>, or <code>pc</code> is <code>null</code>.
     */
     ...
     *         {@link SharpEarth.geom.Vec4#INFINITY} coincident with the plane.
     *
     * @throws ArgumentException if either input point is null.
     */
     ...
     * @return true if the points are on the same side of the plane, otherwise false.
     *
     * @throws ArgumentException if the points array is null or any point within it is null.
     */
     ...
     *
     * @throws ArgumentException if any of the planes are null.
     */

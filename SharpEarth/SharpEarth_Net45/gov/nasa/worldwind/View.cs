...
public interface View : WWObject, Restorable
{
     ...
     *
     * @throws ArgumentException If <code>eyePosition</code> is null.
     */
     ...
     *
     * @throws ArgumentException If the implementation supports field-of-view, and <code>fieldOfView</code> is
     *                                  null.
     */
     ...
     * near and far clipping distances can derive from {@link SharpEarth.view.orbit.BasicOrbitView} or {@link
     * SharpEarth.view.firstperson.BasicFlyView}
     *
     ...
     *
     * @throws ArgumentException if <code>modelPoint</code> is null.
     */
     ...
     * @return the mapped screen coordinate <code>Point</code>.
     *
     * @throws ArgumentException if <code>windowPoint</code> is null.
     */
     ...
     *
     * @throws ArgumentException if <code>referenceCenter</code> is null, if <code>dc</code> is null, or if the
     ...
     * @throws ArgumentException if <code>referenceCenter</code> is null, if <code>dc</code> is null, or if the
     *                                  <code>Globe</code> or <code>GL</code> instances in <code>dc</code> are null.
     * @see #pushReferenceCenter(gov.nasa.worldwind.render.DrawContext, SharpEarth.geom.Vec4)
     */
     ...
     *
     * @throws ArgumentException if <code>distance</code> is negative.
     */
     ...
     * SharpEarth.animation.Animator}.  Starting the {@link SharpEarth.animation.Animator} is the
     * responsibility of the application.
     *
     * @param animator the {@link SharpEarth.animation.Animator} to be added
     */

...
public interface DataRaster : AVList, Disposable
{
     ...
     *
     * @param parameters a list of parameters that specify the width, height and sector of the region to return. Specify
     *               these values using {@link SharpEarth.avlist.AVKey#WIDTH}, {@link
     *               SharpEarth.avlist.AVKey#HEIGHT} and {@link SharpEarth.avlist.AVKey#SECTOR}.
     *
     * @return the requested raster, or null if the raster could not be created.
     *
     * @throws ArgumentException if the specified parameter list is missing the width, height or sector keys or
     *                                  any of those values are invalid.
     */
    DataRaster getSubRaster(AVList parameters);
     ...
     * @return the requested raster, or null if the raster could not be created.
     *
     * @throws ArgumentException if the sector is null or the width, height or sector are invalid.
     */
    DataRaster getSubRaster(int width, int height, Sector sector, AVList parameters);
}
}

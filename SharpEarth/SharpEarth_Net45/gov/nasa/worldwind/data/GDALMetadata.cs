...
using java.util;
using org.gdal.osr.SpatialReference;
...
public class GDALMetadata
{
    ...
    public static AVList extractExtendedAndFormatSpecificMetadata(Dataset ds, AVList extParams, AVList parameters)
        throws ArgumentException, WWRuntimeException
    {
        ...
        return mapExtendedMetadata(ds, extParams, parameters);
    }

    static protected AVList mapExtendedMetadata(Dataset ds, AVList extParams, AVList parameters)
    {
        ...
        convertToWorldWind(extParams, parameters);
    ...
    protected static void mapNITFMetadata(AVList extParams, AVList parameters)
    {
        ...
        if (extParams.hasKey(NITF_ABPP))
        {
            ...
            if (!WWUtil.isEmpty(o) && o instanceof String)
            {
                ...
                if (null != abpp)
                    parameters.setValue(AVKey.RASTER_BAND_ACTUAL_BITS_PER_PIXEL, abpp);
            }
        }
        ...
        if (extParams.hasKey(NITF_DYNAMIC_RANGE))
        {
            ...
            if (!WWUtil.isEmpty(o) && o instanceof String)
            {
                ...
                if (null != maxPixelValue)
                    parameters.setValue(AVKey.RASTER_BAND_MAX_PIXEL_VALUE, maxPixelValue);
            }
        }
...
//                            parameters.setValue(AVKey.MISSING_DATA_SIGNAL, (double)color );
//                        }
//                        else if( s.length == 1 )
//                        {

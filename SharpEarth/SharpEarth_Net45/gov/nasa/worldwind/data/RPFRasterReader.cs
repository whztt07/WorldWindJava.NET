...
public class RPFRasterReader extends AbstractDataRasterReader
{
    ...
    protected DataRaster[] doRead(Object source, AVList parameters) throws java.io.IOException
    {
        ...
        {
            return this.readNonPolarImage(source, parameters);
        }
    }
    ...
    private DataRaster[] readNonPolarImage(Object source, AVList parameters) throws java.io.IOException
    {

...
public class BufferWrapperRaster extends AbstractDataRaster implements Cacheable, Disposable
{
     ...
     * <p/>
     * This returns a <code>{@link SharpEarth.util.BufferWrapper.ByteBufferWrapper}</code>, a subclass of
     ...
     * @param parameters the parameters associated with the sub-raster.
     *
     ...
     */
    protected BufferWrapperRaster createSubRaster(int width, int height, Sector sector, AVList parameters)
    {
...
//        }
    ...
    protected static class InterpolantLookupTable
    {
        ...
        public final bool getInterpolantX(int x, double[] parameters)
        {
            ...
            parameters[2] = this.xParams[3 * x + 2];
        ...
        public final bool getInterpolantY(int y, double[] parameters)
        {
            ...
            parameters[2] = this.yParams[3 * y + 2];
            return parameters[0] != -1d;
        }

        public final void computeRangeX(double[] parameters)
        {
            computeInterpolantRange(this.xParams, this.width, parameters);
        }

        public final void computeRangeY(double[] parameters)
        {
            computeInterpolantRange(this.yParams, this.height, parameters);
        }

        protected static void computeInterpolantRange(double[] parameters, int size, double[] result)
        {

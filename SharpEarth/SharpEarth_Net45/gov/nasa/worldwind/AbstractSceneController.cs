...
//            dc.applyGroupingFilters();
    ...
    /**
     * Builds a composite representation for all {@link SharpEarth.render.SurfaceObject} instances in the draw
     * context's ordered surface renderable queue. While building the composite representation this invokes {@link
     * SharpEarth.render.SurfaceObject#render(gov.nasa.worldwind.render.DrawContext)} in ordered rendering mode.
     ...
     *
     * @see SharpEarth.render.DrawContext#getOrderedSurfaceRenderables()
     */
     ...
     * SharpEarth.render.SurfaceObject} instances in the draw context's ordered surface renderable queue. This

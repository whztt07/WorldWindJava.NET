    ...
    implements RetrievalService, Thread.UncaughtExceptionHandler
{
    ...
    private class RetrievalExecutor extends ThreadPoolExecutor
    {
         ...
         *
         * @throws ArgumentException if either <code>thread</code> or <code>runnable</code> is null
         */
     ...
     *
     * @throws ArgumentException if <code>retriever</code> is null or has no name
     */
     ...
     *
     * @throws ArgumentException if <code>poolSize</code> is non-positive
     */

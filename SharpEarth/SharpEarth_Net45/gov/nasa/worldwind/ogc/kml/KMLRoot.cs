 ...
 * are given in the Description section of {@link SharpEarth.ogc.kml}.
 *
 * @author tag
...
public class KMLRoot : KMLAbstractObject , KMLRenderable
{
     ...
     * SharpEarth.ogc.kml.KMLConstants#KML_NAMESPACE}).
     *
     ...
     *
     * @see SharpEarth.util.xml.XMLParserNotification
     */
     ...
     *
     * @throws ArgumentException if the address is null.
     */
     ...
     * asynchronously using the {@link SharpEarth.cache.FileStore}.
     * <p/>
     ...
     * using the {@link SharpEarth.cache.FileStore}.
     * <p/>
    ...
    /**
     * Returns the {@link SharpEarth.ogc.kml.KMLNetworkLinkControl} element if the document root contains it.
     *

...
public class KMLRegion extends KMLAbstractObject
{
     ...
     * <p/>
     * A <code>{@link SharpEarth.ogc.kml.KMLRegion.RegionData}</code> must be current when this method is
     * called.
     *
     * @param dc the current draw context.
     *
     ...
     * regeneration interval. A <code>{@link SharpEarth.ogc.kml.KMLRegion.RegionData}</code> must be current
     ...
     * is <code>clampToGround</code>. A <code>{@link SharpEarth.ogc.kml.KMLRegion.RegionData}</code> must be
    ...
    /**
     * Produces the <code>Extent</code> and the <code>Sector</code> for this Region. Assumes this region's altitude mode
     * is <code>relativeToGround</code>. A <code>{@link SharpEarth.ogc.kml.KMLRegion.RegionData}</code> must be
     * current when this method is called.
     *
     * @param dc  the current draw context.
     * @param box the Region's geographic bounding box.
    ...
    /**
     * Produces the <code>Extent</code> and the <code>Sector</code> for this Region. Assumes this region's altitude mode
     * is <code>absolute</code>. A <code>{@link SharpEarth.ogc.kml.KMLRegion.RegionData}</code> must be current
     * when this method is called.
     *
     * @param dc  the current draw context.
     * @param box the Region's geographic bounding box.
     ...
     * <code>{@link SharpEarth.ogc.kml.KMLRegion.RegionData}</code> must be current when this method is called.
     * <p/>
     ...
     * this region's altitude mode is <code>clampToGround</code>. A <code>{@link SharpEarth.ogc.kml.KMLRegion.RegionData}</code>
     ...
     * SharpEarth.ogc.kml.KMLRegion.RegionData}</code> must be current when this method is called.
     *
     * @param tc  the current KML traversal context.
     * @param dc  the <code>DrawContext</code> to test.
     * @param lod the level of detail criteria that must be met.
    ...
    /**
     * Indicates whether the specified <code>DrawContext</code> meets this Region's level of detail criteria. Assumes
     * this region's altitude mode is <code>absolute</code>. A <code>{@link SharpEarth.ogc.kml.KMLRegion.RegionData}</code>
     * must be current when this method is called.
     *
     * @param tc  the current KML traversal context.
     * @param dc  the <code>DrawContext</code> to test.

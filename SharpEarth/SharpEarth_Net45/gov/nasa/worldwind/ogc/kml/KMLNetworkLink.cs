...
public class KMLNetworkLink extends KMLAbstractContainer implements PropertyChangeListener
{
     ...
     * specify this link's new network resource, and sends an <code>{@link SharpEarth.avlist.AVKey#RETRIEVAL_STATE_SUCCESSFUL}</code>
     ...
     * link's new network resource, and sends an <code>{@link SharpEarth.avlist.AVKey#RETRIEVAL_STATE_SUCCESSFUL}</code>
     * property change event to this link's property change listeners.
     * <p/>

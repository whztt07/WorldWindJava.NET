...
public class KMLLink extends KMLAbstractObject
{
     ...
     * specified in the configuration file using the keys <code>{@link SharpEarth.avlist.AVKey#NAME}</code> and
     * <code>{@link SharpEarth.avlist.AVKey#VERSION}</code>. If not specified, this uses default values of
     * <code>{@link SharpEarth.Version#getVersionName()}</code> and <code>{@link
     * SharpEarth.Version#getVersion()}</code> for <code>[clientName]</code> and <code>[clientVersion]</code>,
     * respectively.
     *
     ...
     *
     * @throws ArgumentException if <code>dc</code> is <code>null</code>.
     * @see #getHref()
     * @see #getViewFormat()
     * @see #getHttpQuery()
     ...
     * <code>httpQuery</code> according to the current <code>{@link SharpEarth.Configuration}</code>
     * parameters.
     *
     * @param dc the <code>DrawContext</code> used to determine the current view parameters.
     *
     ...
     * SharpEarth.geom.Sector#EMPTY_SECTOR}</code> if the globe is not visible.
     *

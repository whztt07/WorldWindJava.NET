 ...
 * instances are created by {@link #createTriangleMesh(java.util.List, SharpEarth.ogc.collada.ColladaBindMaterial)
 * createTriangleMesh} and {@link #createLineMesh(java.util.List, SharpEarth.ogc.collada.ColladaBindMaterial)
 * createLineMesh}.
 * <p/>
...
public class ColladaMeshShape extends AbstractGeneralShape
{
    ...
    protected static class ShapeData extends AbstractGeneralShape.ShapeData
    {
         ...
         * SharpEarth.globes.Globe#computeSurfaceOrientationAtPosition(gov.nasa.worldwind.geom.Position)}
    ...
    /**
     * {@inheritDoc} Overridden because this shape uses {@link SharpEarth.ogc.collada.impl.ColladaMeshShape.OrderedMeshShape}
     ...
     *
     * @throws ArgumentException if draw context is null or the draw context GL is null
     */
     ...
     * <p/>
     * A {@link SharpEarth.render.AbstractShape.AbstractShapeData} must be current when this method is called.
     *
     * @param dc        the current draw context.

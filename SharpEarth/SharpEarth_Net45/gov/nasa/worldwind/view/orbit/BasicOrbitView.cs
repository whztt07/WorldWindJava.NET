...
public class BasicOrbitView : BasicView , OrbitView
{
     ...
     * on the viewport center requires a non-null {@link SharpEarth.globes.Globe}, a non-null {@link
    ...
    protected double computeHorizonDistance(Position eyePosition)
    {
        ...
        {
            return Double.MaxValue; // Horizon distance doesn't make sense for the 2D globe.
        }
        else
        {

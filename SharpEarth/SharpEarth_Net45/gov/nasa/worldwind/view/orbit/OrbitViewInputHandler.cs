...
public class OrbitViewInputHandler : BasicViewInputHandler
{
    ...
    /**
     * CollisionAwarePitchAccessor implements an {@link SharpEarth.util.PropertyAccessor.AngleAccessor}
     * interface onto the pitch property of an {@link SharpEarth.view.orbit.OrbitView}. In addition to accessing
    ...
    protected static class CollisionAwarePitchAccessor : PropertyAccessor.AngleAccessor
    {
         ...
         *
         * @throws ArgumentException if the orbitView is null.
         */

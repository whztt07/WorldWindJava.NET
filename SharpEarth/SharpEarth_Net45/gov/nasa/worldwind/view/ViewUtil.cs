...
public class ViewUtil
{
     ...
     *
     * @throws ArgumentException if the field of view is null, or if the distance is negative.
     */
     ...
     *
     * @throws ArgumentException if either the distance or the resolution are negative, or if the depthBits is
     *                                  less than one.
     */

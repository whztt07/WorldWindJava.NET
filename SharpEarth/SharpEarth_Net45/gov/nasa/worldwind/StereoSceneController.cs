 ...
 * {@link SharpEarth.awt.WorldWindowGLCanvas} to learn how to select a stereo device.
 *
 * @author Tom Gaskins
...
public interface StereoSceneController extends SceneController
{
     ...
     * SharpEarth.avlist.AVKey#STEREO_MODE_DEVICE} to request device supported stereo, {@link
     * SharpEarth.avlist.AVKey#STEREO_MODE_RED_BLUE} to request red-blue anaglyph stereo implemented in
     * software, or {@link SharpEarth.avlist.AVKey#STEREO_MODE_NONE} (the default) to request no stereo effect.
     * <p/>
     ...
     *             SharpEarth.avlist.AVKey#STEREO_MODE_NONE}.
     */

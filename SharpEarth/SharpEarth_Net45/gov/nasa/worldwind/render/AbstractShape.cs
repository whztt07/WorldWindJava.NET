...
/**
 * Provides a base class form several geometric {@link SharpEarth.render.Renderable}s. Implements common
    ...
    Restorable, PreRenderable, Attributable
{
     ...
     * polygons to be reported in a {@link SharpEarth.events.SelectEvent} even if several of the polygons are at
     * the pick position.
     * <p/>
     ...
     *
     * @throws ArgumentException if the width is less than 0.
     */
    ...
    /**
     * Creates a {@link SharpEarth.pick.PickedObject} for this shape and the specified unique pick color. The
    ...
    /**
     * Creates a {@link SharpEarth.pick.PickedObject} for this shape and the specified unique pick color code.

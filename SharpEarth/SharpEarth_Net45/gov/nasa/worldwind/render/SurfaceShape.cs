...
/**
 * Common interface for surface conforming shapes such as {@link SharpEarth.render.SurfacePolygon}, {@link
 ...
 * <p/>
 * SurfaceShape extends the {@link SharpEarth.render.SurfaceObject} interface, and inherits SurfaceObject's
    ...
    extends SurfaceObject, Highlightable, ExtentHolder, MeasurableArea, MeasurableLength, Restorable, Attributable
{
     ...
     *
     * @throws ArgumentException if <code>pathType</code> is null.
     */
     ...
     *
     * @throws ArgumentException if <code>texelsPerEdgeInterval</code> is less than or equal to zero.
     ...
     *
     * @throws ArgumentException if either of <code>minEdgeIntervals</code> or <code>maxEdgeIntervals</code> is

...
public class ScreenImage extends WWObjectImpl implements Renderable, Exportable
{
     ...
     *
     * @throws ArgumentException if the specified opacity is less than zero.
     */
    ...
    /**
     * Indicates the object included in {@link SharpEarth.events.SelectEvent}s when this object is picked.
     *
     ...
     *
     * @param delegateOwner the object included in {@link SharpEarth.events.SelectEvent}s as the picked object.
     */

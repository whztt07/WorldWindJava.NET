...
public interface DrawContext : WWObject, Disposable
{
     ...
     *
     * @throws ArgumentException if the capabilities are null.
     */
     ...
     *
     * @throws ArgumentException if pickedObjects is <code>null</code>.
     */
     ...
     *
     * @throws ArgumentException if pickedObject is <code>null</code>.
     */
     ...
     *
     * @throws ArgumentException if the point is <code>null</code>.
     */
     ...
     *
     * @throws ArgumentException if the rectangle is <code>null</code>.
     */
     ...
     *
     * @throws ArgumentException if the ordered renderable is null.
     */
     ...
     *
     * @throws ArgumentException if either the key or display name are null.
     ...
     *
     * @throws ArgumentException if the list is null.
     ...
     *
     * @throws ArgumentException if the cache is null.
     */
     ...
     *
     * @throws ArgumentException if <code>annotationRenderer</code> is null;
     */
     ...
     *
     * @throws ArgumentException if the resolutions array or the search sector is null.
     */
     ...
     *
     * @throws ArgumentException if the credit is null.
     */
    ...
    /**
     * Indicates whether a new frame should be generated by the {@link SharpEarth.SceneController}.
     *
    ...
    /**
     * Requests that a new frame should be generated by the {@link SharpEarth.SceneController}.
     *
     ...
     * context's {@link SharpEarth.render.OrderedRenderable}s. See {@link #isOrderedRenderingMode()} for more
     * information.
     *
     ...
     *
     * @param renderer an object implementing the {@link SharpEarth.render.OutlinedShape} interface for the
     *                 shape.
     ...
     *
     * @throws ArgumentException if either the latitude or longitude is null.
     */
    ...
    /**
     * Returns the next {@link SharpEarth.render.OrderedRenderable} on the ordered-renderable priority queue but
    ...
    /**
     * Returns the next {@link SharpEarth.render.OrderedRenderable} on the ordered-renderable priority queue and
     ...
     *
     * @throws ArgumentException if the position is null.
     */

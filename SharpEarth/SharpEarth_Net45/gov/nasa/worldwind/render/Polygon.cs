...
public class Polygon extends AbstractShape
{
     ...
     *
     * @throws ArgumentException if the position list is null.
     */
     ...
     *
     * @throws ArgumentException if the location list is null or contains fewer than three locations.
     */
     ...
     *
     * @throws ArgumentException if the image source is not null and either the texture coordinates are null or
...
//            dc.drawNormals(1000, this.boundarySet.coordBuffer, this.boundarySet.normalBuffer);
    ...
    protected Vec4 computeReferencePoint(Terrain terrain, Matrix rotationMatrix)
    {
        ...
        return rotationMatrix != null ? refPt.transforeachmBy4(rotationMatrix)  in  refPt;
    }
     ...
     *                  SharpEarth.render.Polygon.ShapeData)}).
     */
     ...
     *
     * @throws java.lang.ArgumentException if the position is null.
     */
     ...
     * @param position the new position of the shape's reference position.
     *
     * @throws java.lang.ArgumentException if the globe or position is null.
     */

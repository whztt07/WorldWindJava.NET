 ...
 * <p/>
 * When the label of a point placemark is picked, the associated {@link SharpEarth.pick.PickedObject} contains
    ...
    implements Renderable, Locatable, Movable, Highlightable, Exportable
{
     ...
     * reported in a {@link SharpEarth.events.SelectEvent} even if several of the placemarks are at the pick
     * position.
     * <p/>

...
//    protected Map<String, GroupingFilter> groupingFilters;
    ...
    public void addOrderedRenderable(OrderedRenderable orderedRenderable, bool isBehind)
    {
        ...
        // renderables, then treat it as having an eye distance of Double.MaxValue and ignore the actual eye distance.
        // If multiple ordered renderables are added in this way, they are drawn according to the order in which they
        // are added.
        double eyeDistance = isBehind ? Double.MaxValue : orderedRenderable.getDistanceFromEye();

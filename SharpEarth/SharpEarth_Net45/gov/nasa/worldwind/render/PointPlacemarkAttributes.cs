...
public class PointPlacemarkAttributes implements Exportable
{
    ...
    /**
     * Specifies a {@link java.awt.image.BufferedImage} for {@link SharpEarth.render.PointPlacemark}s associated
    ...
    /**
     * Specifies the heading reference. If {@link SharpEarth.avlist.AVKey#RELATIVE_TO_SCREEN}, the heading is
     * interpreted as relative to the screen and the placemark icon maintains the heading relative to the screen's
     * vertical edges. If {@link SharpEarth.avlist.AVKey#RELATIVE_TO_GLOBE}, the heading is interpreted relative
     ...
     * SharpEarth.avlist.AVKey#RELATIVE_TO_SCREEN}.
     *

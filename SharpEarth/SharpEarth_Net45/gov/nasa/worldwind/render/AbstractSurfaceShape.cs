...
using SharpEarth.util.measure.AreaMeasurer;
...
/**
 * Common superclass for surface conforming shapes such as {@link SharpEarth.render.SurfacePolygon}, {@link
 * SharpEarth.render.SurfacePolyline}, {@link SharpEarth.render.SurfaceEllipse}, {@link
 * SharpEarth.render.SurfaceQuad}, and {@link SharpEarth.render.SurfaceSector}.
 * <p/>
 ...
 * <p/>
 * AbstractSurfaceShape extends from {@link SharpEarth.render.AbstractSurfaceObject}, and therefore inherits
    ...
    Combinable
{
     ...
     * attributes. The returned state key has no dependency on the {@link SharpEarth.globes.Globe}. Subclasses
    ...
    /**
     * Returns this SurfaceShape's enclosing volume as an {@link SharpEarth.geom.Extent} in model coordinates,
     * given a specified {@link SharpEarth.globes.Globe} and vertical exaggeration (see {@link
     ...
     * SharpEarth.render.AbstractSurfaceObject.SurfaceObjectStateKey} by adding the shape's current {@link
     * SharpEarth.render.ShapeAttributes} and the globe's state key.
     * <p/>
    ...
    protected static class SurfaceShapeStateKey extends SurfaceObjectStateKey
    {
         ...
         *
         * @see SharpEarth.globes.Globe#getStateKey(DrawContext)
         */

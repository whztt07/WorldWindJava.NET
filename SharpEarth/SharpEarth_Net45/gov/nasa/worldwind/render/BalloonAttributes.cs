...
/**
 * Holds attributes for World Wind {@link SharpEarth.render.Balloon} shapes. Changes made to the attributes are
...
public interface BalloonAttributes : ShapeAttributes
{
     ...
     *
     * @throws ArgumentException if <code>size</code> is <code>null</code>.
     * @see #getSize()
     * @see #getMaximumSize()
     ...
     *
     * @throws ArgumentException if <code>offset</code> is <code>null</code>.
     * @see #getOffset()
     */
     ...
     *
     * @throws ArgumentException if <code>insets</code> is <code>null</code>.
     * @see #getInsets()
     */
     ...
     *
     * @return the balloon frame's shape, either {@link SharpEarth.avlist.AVKey#SHAPE_NONE}, {@link
     *         SharpEarth.avlist.AVKey#SHAPE_RECTANGLE}, or {@link SharpEarth.avlist.AVKey#SHAPE_ELLIPSE}.
     *
     ...
     * SharpEarth.avlist.AVKey#SHAPE_NONE}</li> <li>{@link SharpEarth.avlist.AVKey#SHAPE_RECTANGLE}</li>
     * <li>{@link SharpEarth.avlist.AVKey#SHAPE_ELLIPSE}</li> </ul>
     * <p/>
     ...
     *
     * @throws ArgumentException if <code>shape</code> is <code>null</code>.
     * @see #getBalloonShape()
     */
     ...
     *
     * @return the balloon leader's shape, either {@link SharpEarth.avlist.AVKey#SHAPE_NONE} or {@link
     *         SharpEarth.avlist.AVKey#SHAPE_TRIANGLE}.
     *
     ...
     * SharpEarth.avlist.AVKey#SHAPE_NONE}</li> <li>{@link SharpEarth.avlist.AVKey#SHAPE_TRIANGLE}</li>
     * </ul>
     * <p/>
     ...
     *
     * @throws ArgumentException if <code>width</code> is less than zero.
     * @see #getLeaderWidth()
     */
     ...
     *
     * @throws ArgumentException if <code>radius</code> is less than zero.
     * @see #getCornerRadius()
     */
     ...
     *
     * @throws ArgumentException if <code>font</code> is <code>null</code>.
     * @see #getFont()
     */
     ...
     *
     * @throws ArgumentException if <code>color</code> is <code>null</code>.
     * @see #getTextColor()
     */
     ...
     *
     * @throws ArgumentException if <code>opacity</code> is less than 0.0 or greater than 1.0.
     * @see #getImageOpacity()
     */
     ...
     *
     * @return the balloon texture's repeat mode, one of {@link SharpEarth.avlist.AVKey#REPEAT_NONE}, {@link
     *         SharpEarth.avlist.AVKey#REPEAT_X}, {@link SharpEarth.avlist.AVKey#REPEAT_Y}, or {@link
     *         SharpEarth.avlist.AVKey#REPEAT_XY}
     *
     ...
     * following: <ul> <li>{@link SharpEarth.avlist.AVKey#REPEAT_NONE}</li> <li>{@link
     * SharpEarth.avlist.AVKey#REPEAT_X}</li> <li>{@link SharpEarth.avlist.AVKey#REPEAT_Y}</li>
     * <li>{@link SharpEarth.avlist.AVKey#REPEAT_XY}</li> </ul>
     * <p/>
     ...
     *
     * @throws ArgumentException if <code>repeat</code> is <code>null</code>.
     * @see #getImageRepeat()
     */

 ...
 * SharpEarth.render.SurfaceShape}. SurfaceObject implements the {@link SharpEarth.render.Renderable}
 ...
 * {@link SharpEarth.render.DrawContext#addOrderedSurfaceRenderable(OrderedRenderable)} during the preRender,
...
public interface SurfaceObject : OrderedRenderable, SurfaceRenderable, PreRenderable, AVList
{
    ...
    /**
     * Returns the surface object's enclosing volume as an {@link SharpEarth.geom.Extent} in model coordinates,
     * given a specified {@link SharpEarth.render.DrawContext}.
     *

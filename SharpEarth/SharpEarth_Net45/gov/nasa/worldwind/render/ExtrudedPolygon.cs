...
public class ExtrudedPolygon : AbstractShape
{
     ...
     *                only when the altitude mode is {@link WorldWind#CONSTANT}, which is the default for this shape.
     *
     * @throws ArgumentException if the location list is null or the height is specified but less than or equal
     *                                  to zero.
     */
     ...
     *
     * @throws ArgumentException if the height is less than or equal to zero.
     */
...
//            dc.drawNormals(1000, this.vertexBuffer, this.normalBuffer);
     ...
     *                  SharpEarth.render.ExtrudedPolygon.ShapeData)}).
     */

...
/**
 * Holds common attributes for World Wind shapes such as {@link SharpEarth.render.Path}, {@link
 * SharpEarth.render.Polygon}, and {@link SharpEarth.render.SurfaceShape}. Changes made to the
...
public interface ShapeAttributes extends Exportable
{
     ...
     *
     * @throws ArgumentException if <code>material</code> is <code>null</code>.
     ...
     *
     * @throws ArgumentException if <code>factor</code> is less than zero.
     ...
     *
     * @throws ArgumentException if <code>scale</code> is less than or equal to zero.
     * @see #getImageScale()
     * @see #setImageSource(Object)
     */
     ...
     *
     * @throws ArgumentException if <code>rs</code> is <code>null</code>.
     */

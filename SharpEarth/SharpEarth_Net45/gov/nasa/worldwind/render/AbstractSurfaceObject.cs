...
/**
 * Abstract implementation of SurfaceObject that participates in the {@link SharpEarth.SceneController}'s bulk
 * rendering of SurfaceObjects. The SceneControllers bulk renders all SurfaceObjects added to the {@link
 * SharpEarth.render.DrawContext}'s ordered surface renderable queue during the preRendering pass. While
 ...
 * are consistent with the current {@link SharpEarth.View}.</li> </ol>
 *
 * @author dcollins
...
public abstract class AbstractSurfaceObject extends WWObjectImpl implements SurfaceObject
{
    ...
    /**
     * Prepares the SurfaceObject as an {@link SharpEarth.render.OrderedRenderable} and adds it to the
     ...
     * <p/>
     * During ordered preRendering, the {@link SharpEarth.SceneController} builds a composite representation of
     ...
     * <p/>
     * During ordered picking, the {@link SharpEarth.SceneController} invokes the SurfaceObject's {@link
    ...
    /**
     * Create a {@link SharpEarth.pick.PickedObject} for this surface object. The PickedObject created by this

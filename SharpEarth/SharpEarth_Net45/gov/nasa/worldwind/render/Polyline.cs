...
using SharpEarth.util.measure.LengthMeasurer;
    ...
    MeasurableLength, ExtentHolder, PreRenderable, Highlightable
{
    ...
    /**
     * Returns this Polyline's enclosing volume as an {@link SharpEarth.geom.Extent} in model coordinates, given
     * a specified {@link SharpEarth.globes.Globe} and vertical exaggeration (see {@link
    ...
    /**
     * Returns this Polyline's enclosing volume as an {@link SharpEarth.geom.Extent} in model coordinates, given
     * a specified {@link SharpEarth.render.DrawContext}. The returned Extent may be different than the Extent
     ...
     * @return this Polyline's Extent in model coordinates.
     *
     * @throws ArgumentException if the DrawContext is null, or if the Globe held by the DrawContext is null.
     */

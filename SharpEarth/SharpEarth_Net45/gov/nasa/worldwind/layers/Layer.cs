...
public interface Layer extends WWObject, Disposable, Restorable
{
     ...
     * SharpEarth.render.SurfaceImage} and {@link SharpEarth.layers.SurfaceImageLayer}} when the image
     ...
     * <p/>
     * The returned altitude is valid when the field of view indicated by {@link SharpEarth.View#getFieldOfView()}
     ...
     *
     * @param radius the radius of the {@link SharpEarth.globes.Globe} the layer is associated with. May be
     *               null, in which case the Earth's equatorial radius is used, {@link SharpEarth.globes.Earth#WGS84_EQUATORIAL_RADIUS}.
     *

...
public class TextureTile extends Tile implements SurfaceTile
{
     ...
     * SharpEarth.util.Level, int, int)} to create sub tiles not found in the cache.
     *
     * @param nextLevel the level for the sub tiles.
     *
     * @return a four-element array containing this texture tile's sub tiles.
     *
     * @throws ArgumentException if the level is null.
     */
    ...
    /**
     * Creates a sub tile of this texture tile with the specified {@link SharpEarth.geom.Sector}, {@link
     * SharpEarth.util.Level}, row, and column. This is called by {@link #createSubTiles(gov.nasa.worldwind.util.Level)},
    ...
    /**
     * Returns a key for a sub tile of this texture tile with the specified {@link SharpEarth.util.Level}, row,

...
public class LocalRasterServerLayer extends BasicTiledImageLayer
{
     ...
     */
    public LocalRasterServerLayer(AVList parameters)
    {
        super(params);
     ...
     *                                  list.
     */
    public LocalRasterServerLayer(Document dom, AVList parameters)
    {
     ...
     *                                  list.
     */
    public LocalRasterServerLayer(Element domElement, AVList parameters)
    {

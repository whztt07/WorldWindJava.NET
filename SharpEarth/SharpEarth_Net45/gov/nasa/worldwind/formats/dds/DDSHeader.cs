...
public class DDSHeader
{
    ...
    {
        bool sourceIsInputStream = (null != source && source instanceof InputStream);
     ...
     * @param buffer
     * @return DDSHeader
     * @throws ArgumentException if the ByteBuffer is null
     * @throws IOException              if the buffer length or content is invalid
     */
    public static DDSHeader readFrom(ByteBuffer buffer) throws ArgumentException, IOException
    {
        if (null == buffer)
        {

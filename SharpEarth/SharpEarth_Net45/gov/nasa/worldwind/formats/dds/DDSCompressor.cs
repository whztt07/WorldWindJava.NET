 ...
 * <p/>
 * Each compression method accepts a reference to a {@link SharpEarth.formats.dds.DXTCompressionAttributes}.
...
public class DDSCompressor
{
     ...
     * @throws java.io.IOException      if <code>stream</code> is in a format understood by ImageIO, but the image data
     *                                  cannot be read by ImageIO.
     * @throws ArgumentException if <code>stream</code> is null.
     */
     ...
     * {#compressImage(java.awt.image.BufferedImage, SharpEarth.formats.dds.DXTCompressionAttributes)} with the
     ...
     * @throws ArgumentException if either <code>imageBuffer</code> or <code>attributes</code> are null.
     */
     ...
     * @throws java.io.IOException      if the bytes in <code>imageBuffer</code> are in a format understood by ImageIO,
     *                                  but the image data cannot be read by ImageIO.
     * @throws ArgumentException if <code>imageBuffer</code> is null.
     */
     ...
     * SharpEarth.formats.dds.DXTCompressionAttributes)} with the BufferedImage created by ImageIO and the
     ...
     *                                  cannot be read by ImageIO.
     * @throws ArgumentException if either the <code>file</code> or the <code>attributes</code> are null, if the
     ...
     * @throws java.io.IOException      if <code>file</code> is in a format understood by ImageIO, but the image data
     *                                  cannot be read by ImageIO.
     * @throws ArgumentException if <code>file</code> is null, does not exist, or read permission is not allowed
     ...
     *                                  cannot be read by ImageIO.
     * @throws ArgumentException if either the <code>url</code> or the <code>attributes</code> are null.
     */
     ...
     * @throws java.io.IOException      if <code>url</code> is in a format understood by ImageIO, but the image data
     *                                  cannot be read by ImageIO.
     * @throws ArgumentException if <code>url</code> is null.
     */
     ...
     *
     * @throws ArgumentException if <code>image</code> is null, or if <code>image</code> has non power of two
     *                                  dimensions.
     */
     ...
     *
     * @throws ArgumentException if either <code>image</code> or <code>attributes</code> are null, or if

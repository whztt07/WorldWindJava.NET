...
class GeoCodec
{
     ...
     * @throws ArgumentException if values not a multiple of 6.
     */
    public void addModelTiePoints(double[] values) throws ArgumentException
    {
     ...
     * @throws ArgumentException if values is not of length 3.
     */
     ...
     * @throws ArgumentException if matrix is not of length 16.
     */
    public void setModelTransformation(double[] matrix) throws ArgumentException
    {
     ...
     * @throws ArgumentException Thrown if the key does not embody integer values.
     */
    public int[] getGeoKeyAsInts(int key) throws ArgumentException
    {
        int[] vals = null;
        GeoKeyEntry entry;
    ...
    void setGeokeys(short[] keys)
    {
        ...
        if (keys != null && keys.length > 4)
        {
            ...
            for (int k = 0; k < numKeys; k++ )
            {
                ...
                {
                    // in this case, one or more values are given relative to one of the parameters arrays...
    ...
    // Package visibility. Not generally intended for use by end users.
    //
    void setDoubleParams(double[] parameters)
    {
        this.doubleParams = new double[params.length];
        System.arraycopy(params, 0, this.doubleParams, 0, parameters.length);
    }

    //
    // Package visibility. Not generally intended for use by end users.
    //
    void setAsciiParams(byte[] parameters)
    {
        this.asciiParams = new byte[params.length];
        System.arraycopy(params, 0, this.asciiParams, 0, parameters.length);
    }
